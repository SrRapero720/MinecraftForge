...
public class SaplingGrowTreeEvent extends LevelEvent
{
    ...
    public SaplingGrowTreeEvent(LevelAccessor level, Random rand, BlockPos pos)
    {
        this(level, rand, pos, null);
    }

    public SaplingGrowTreeEvent(LevelAccessor level, Random rand, BlockPos pos, Holder<? extends ConfiguredFeature<?, ?>> feature)
    {
        super(level);
        this.rand = rand;
        this.pos = pos;
