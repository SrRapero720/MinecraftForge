...
public class StructureSpawnListGatherEvent extends Event
{
    ...
    private final Map<MobCategory, List<SpawnerData>> entitySpawns = new HashMap<>();
    private final Map<MobCategory, List<SpawnerData>> entitySpawnsUnmodifiableLists = new HashMap<>();
    private final Map<MobCategory, List<SpawnerData>> entitySpawnsUnmodifiable = Collections.unmodifiableMap(entitySpawnsUnmodifiableLists);
     ...
     */
    public List<SpawnerData> getEntitySpawns(MobCategory classification)
    {
     ...
     */
    private List<SpawnerData> getOrCreateEntitySpawns(MobCategory classification)
    {
     ...
     */
    public void addEntitySpawn(MobCategory classification, SpawnerData spawner)
    {
     ...
     */
    public void addEntitySpawns(MobCategory classification, List<SpawnerData> spawners)
    {
     ...
     * @param spawner        Spawner
     */
    public void removeEntitySpawn(MobCategory classification, SpawnerData spawner)
    {
     ...
     */
    public Map<MobCategory, List<SpawnerData>> getEntitySpawns()
    {
