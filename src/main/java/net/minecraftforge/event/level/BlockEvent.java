...
public class BlockEvent extends Event
{
    ...
    public static class BreakEvent extends BlockEvent
    {
        ...
        public BreakEvent(Level level, BlockPos pos, BlockState state, Player player)
        {
            ...
            else
            {
                ...
                this.exp = state.getExpDrop(level, pos, fortuneLevel, silkTouchLevel);
            }
        }
     ...
     * {@link net.minecraft.block.BlockPortal#trySpawnPortal(Level, BlockPos)}.
     *
     ...
     *
     * @deprecated Use {@link BlockToolModificationEvent} and put level-modifying actions behind <code>if (!event.isSimulated())</code>.
     */
    @Cancelable
    ...
    public static class BlockToolInteractEvent extends BlockToolModificationEvent
    {
        ...
        public BlockToolInteractEvent(LevelAccessor level, BlockPos pos, BlockState originalState, Player player, ItemStack stack, ToolAction toolAction)
        {
            super(level, pos, originalState, toolAction);
            this.player = player;
            this.stack = stack;
        }
     ...
     * {@link ToolActions#SHOVEL_FLATTEN a shovel can path}, or {@link ToolActions#HOE_TILL a hoe can till}.
     * <p>
     * Care must be taken to ensure level-modifying events are only performed if {@link #isSimulated()} returns {@code true}.
     * <p>
     * This event is {@link Cancelable}. If canceled, this will prevent the tool
     * from changing the block's state.
     */
